...
class TodoistService {
  ...
  static Future<bool> createTask(String title, String description, String name, bool isBug) async {
    try {
      ...
      request.body =
          'commands=[{"type": "item_add","uuid": "${requestUuid.toString()}","temp_id": "${tempId.toString()}","args": {"project_id": "6M54c44jm5c5P8p9","section_id": "6Xv7m8gpVG6CW24h","content": "$title","description": ${description == '' ? '""' : '"$name: $description"'},"labels": ${isBug ? '["bug"]' : '[]'}}}]';
