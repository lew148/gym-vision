...
class _WorkoutSetFormState extends State<WorkoutSetForm> {
  ...
  Future<WorkoutSet?> onAddSubmit(Exercise exercise, {bool addThree = false}) async {
    ...
    try {
      ...
      if (mounted) ToastHelper.showFailureToast(context, message: 'Failed to add set(s) to workout!');
      return null;
    }
  }
  ...
  Future<WorkoutSet?> onEditSubmit() async {
    ...
    try {
      ...
      if (mounted) ToastHelper.showFailureToast(context, message: 'Failed to edit workout set!');
      return null;
    }
  }
